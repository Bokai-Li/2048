let keypress,Game;_88d‍.w("keypress",[["default",["keypress"],function(v){keypress=v}]]);_88d‍.w("./engine/game",[["default",["Game"],function(v){Game=v}]]);
...
_88d‍.g.console.log(game.toString());
...
game.onWin(gameState => {
    _88d‍.g.console.log('You won with a gameState of...', gameState)
});

game.onLose(gameState => {
    _88d‍.g.console.log('You lost! :(', gameState)
